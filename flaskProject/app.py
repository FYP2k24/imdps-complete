...
def predictstroke():
    ...
    output = prediction[0]
    if output == 1:
        return render_template('stroke.html', prediction_text='The person is likely to have stroke .')
    else:
        return render_template('stroke.html', prediction_text='The person is not likely to have stroke .')
